...
//	printk("\n lookup.c->amfs_init_dentry_cache"); //aditi
	return amfs_dentry_cachep ? 0 : -ENOMEM;
}

void amfs_destroy_dentry_cache(void)
{
//	 printk("\n lookup.c->amfs_destroy_dentry_cache"); //aditi
...
{	
//	 printk("\n lookup.c->free_dentry_private_data"); //aditi
...
//	 printk("\n lookup.c->amfs_inode_test"); //aditi
...
//	 printk("\n lookup.c->struct inode amfs_iget"); //aditi
...
//	 printk("\n lookup.c-> struct dentry * _amfs_lookup"); //aditi
