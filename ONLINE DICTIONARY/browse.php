...
<tr><td> <div class="scroll_left">
   <h3><b> <u> <center>  A </center></u></b>
<hr />
<left>
<?php
...
echo"<ul >";
$q="select word from word where word like '	A%'";
$res=mysql_query($q) or die(mysql_error());
while($rows=mysql_fetch_array($res))
{
extract($rows);
echo"<li><a href='word_meaning_display_browse.php?word1=$word'>$word</a> </li><br />";
}
echo"<h3><b> <u> <center>  B </center></u></b></h3><hr />";
$q="select word from word where word like '	B%'";
$res=mysql_query($q) or die(mysql_error());
while($rows=mysql_fetch_array($res))
{
extract($rows);
...
echo"<h3><b> <u> <center>  C </center></u></b></h3><hr />";
$q="select word from word where word like '	C%'";
$res=mysql_query($q) or die(mysql_error());
while($rows=mysql_fetch_array($res))
{
extract($rows);
...
document.write("<small><font color='000000' face='Arial'><b>"+dayarray[day]+", "+montharray[month]+" "+daym+", "+year+"</b></font></small>")
  ...
  <div id="content">
   <div class="scroll_content">
     <div id="show_details" style="text-align:left">
<pre>
    <h3><center><u><i> abase</i> </u> </center></h3>
...
See abase defined for English-language learners 

See abase defined for kids 

<u>Examples of ABASE </u>
...
Middle English abassen, from Anglo-French abesser, abaisser, from a- (from Latin ad-) + -besser, 
from Vulgar Latin *bassiare to lower

First Known Use: 15th century

Related to ABASE

Synonyms: debase, bastardize, canker, cheapen, corrupt, debauch, degrade, demean, demoralize,
 deprave, deteriorate, lessen, pervert, poison, profane, prostitute, subvert, vitiate, warp

Antonyms: elevate, ennoble, uplift
[+]more

Rhymes with ABASE
airspace, Alsace, ambsace, apace, backspace, best-case, biface, birthplace, blackface, boldface,
 bookcase, bootlace, braincase, briefcase,...
[+]more

Learn More About ABASE

*Thesaurus: All synonyms and antonyms for "abase"
*Spanish-English Dictionary: Translation of "abase"
*Browse
*Next Word in the Dictionary: abash
*Previous Word in the Dictionary: à bas
 
All Words Near: abase
Seen & Heard

What made you want to look up abase? Please tell us where you read or heard it (including the quote, if possible).
</pre>
  </div>
   </div> 
...
<textarea name="suggsetions" rows="6" cols="27">
</textarea>
</h4></div></div>
