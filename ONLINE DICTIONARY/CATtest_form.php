...
document.write("<small><font color='000000' face='Arial'><b>"+dayarray[day]+", "+montharray[month]+" "+daym+", "+year+"</b></font></small>")
 ...
 <div class="scroll_content">
        ...
        <form action="CATtest_form2.php" method="POST">
            ...
            <center> <table border="10">
             ...
             <tr><td>PASSWORD:</td><td><input type='password' name='password' /></td>    
              <tr><td colspan="2"> CHOOSE EXAM TYPE:</td></tr>
               <tr><td> <input type="radio" name="exam" value="gre" /></td><td>GRE</td></tr>
                <tr><td><input type="radio" name="exam" value="sat" /></td><td>SAT</td></tr>
                <tr><td><input type="radio" name="exam" value="gmat" /></td><td>GMAT</td></tr>
                <tr><td><input type="radio" name="exam" value="toefl" /></td><td>TOEFL</td></tr>
                <tr><td colspan="2"> CHOOSE EXAM DIFFICULTY:</td></tr>
                <tr><td><input type="radio" name="difficulty" value="easy" /></td><td>EASY</td></tr>
                <tr><td><input type="radio" name="difficulty" value="medium" /></td><td>MEDIUM</td></tr>
                <tr><td><input type="radio" name="difficulty" value="hard" /></td><td>HARD</td></tr>
